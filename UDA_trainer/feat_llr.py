...
def train_llr_feat(batch_iterator, model_fe, model_cls, opt, it, criterion_cls, criterion_kl,
    ...
    # forward
    output_tgt = model_cls(img_tgt, feat=False)
    ...
    src_loss = torch.tensor(0.0).cuda()
    loss = tgt_loss
