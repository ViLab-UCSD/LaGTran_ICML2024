...
mapping = json.load(open("/home/tarun/unida_classMapping.txt"))
...
for classname in tqdm(mapping.keys()):
    ...
    print("Counter id: {}, Photos Collected: {}".format(counter, len(all_photos[classname])))
    print()

with open("/home/tarun/GeoDA_Project/geoData/uniDA/challenge_test_unida.json", "w") as fh:
    json.dump( {"challenge_unida":all_photos}, fh)